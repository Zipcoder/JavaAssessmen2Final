...
//
//        2. An area method that has two integer parameters, height and width, and
//          returns an integer denoting the area of a height × width rectangle.

//        3. An area method that has one integer parameter, radius, and
//          returns a double denoting the area of a circle (i.e., 3.14 × radius2).
//
//
